...
st.markdown("- Model has Accuracy of ~88%")
st.markdown("- Model is trained with a simple shallow convolutional network")
st.download_button(
    label="Download Age Model",
    data="./models/age_model.hdf5",
    file_name="age_model.hdf5",
)

image1 =  "./images/age_model.png"
image2  = "./images/age_metrics.png"
